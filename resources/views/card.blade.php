...
<div class="card">
  ...
  <div class="card-body">
    <h5 class="card-title">{{ $bookId->description }}</h5>
    <p class="card-text">{{ $bookId->preview }}</p>
    <p class="card-text">Автор: {{ $author->name }}</p>
    <p class="card-text">Год издания: {{ $bookId->year }}</p>
    <a href="/book" class="btn btn-warning">Вернуться назад</a>
  </div>
</div>
